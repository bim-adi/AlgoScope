          ...
          >
            <div className="flex-1 flex flex-col gap-4 p-4">
              ...
              <div className="max-w-4xl mx-auto p-6">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">About AlgoScope</h1>
                <div className="prose prose-lg text-gray-700">
                  ...
                  <p className="mb-4">
                    Our goal is simple — to make Data Structures and Algorithms (DSA) 
                    learning more visual, hands-on, and fun. Instead of reading static 
                    pseudocode, users can watch how each algorithm behaves in real time, 
                    adjust input data, and compare performance across different techniques.
                  </p>
                  <p className="mb-6">
                    Built with modern web technologies like React, Vite, and Tailwind CSS,
                    AlgoScope is designed for speed, clarity, and smooth interaction
                    — perfect for both students and educators.
                  </p>
                  
                  <h2 className="text-2xl font-semibold mb-4 text-gray-800">✨ Features</h2>
                  <ul className="list-disc list-inside mb-6 space-y-2">
                    <li>Visualize sorting and searching algorithms in real time</li>
                    ...
                    <li>Interactive controls for input size and execution speed</li>
                  </ul>
                  
                  <h2 className="text-2xl font-semibold mb-4 text-gray-800">👩‍💻 Our Vision</h2>
                  <p>
                    Learning algorithms shouldn't be about memorizing code — it should be 
                    about understanding how they work. AlgoScope bridges that gap by turning 
                    logic into motion, empowering learners to see the flow behind every operation.
                  </p>
                </div>
              </div>
            </div>
