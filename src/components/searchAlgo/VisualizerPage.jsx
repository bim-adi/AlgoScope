...
export const VisualizerPage = () => {
  ...
  return (
    <>
      <motion.div
        className="lg:w-full w-auto flex flex-col lg:flex-row p-4 bg-slate-50 min-h-screen shadow-md rounded-2xl backdrop-blur supports-[backdrop-filter]:bg-white/60 "
