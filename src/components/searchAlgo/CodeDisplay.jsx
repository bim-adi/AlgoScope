...
export const CodeDisplay = ({ algorithm }) => {
  ...
  return (
    <div className="m-auto p-6 rounded-xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 shadow-2xl border border-slate-700 w-77 md:w-auto lg:w-auto xl:w-auto 2xl:w-auto">
